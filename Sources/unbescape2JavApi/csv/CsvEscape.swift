...
public struct CsvEscape {
   ...
   * @since 1.1.2
   */
  public static func escapeCsv(_ text : String, _ writer : java.io.Writer) throws {
    try CsvEscapeUtil.escape(InternalStringReader(text), writer);
  }
   ...
   * @since 1.1.2
   */
  public static func escapeCsv(_ reader : java.io.Reader, _ writer : java.io.Writer) throws {
    try CsvEscapeUtil.escape(reader, writer);
  }
   ...
   * @throws IOException if an input/output exception occurs
   */
  public static func escapeCsv(_ text : [Character], _ offset : Int, _ len : Int, _ writer : java.io.Writer) throws {
    let textLen : Int = text.length
    ...
    try CsvEscapeUtil.escape(text, offset, len, writer);
  }
   ...
   *         return <kbd>null</kbd> if input is <kbd>null</kbd>.
   */
  public static func unescapeCsv(_ text : String) -> String{
   ...
   * @since 1.1.2
   */
  public static func unescapeCsv(_ text : String, _ writer : java.io.Writer) throws {
    try CsvEscapeUtil.unescape(InternalStringReader(text), writer);
  }
   ...
   * @since 1.1.2
   */
  public static func unescapeCsv(_ reader : java.io.Reader, _ writer : java.io.Writer) throws  {
    try CsvEscapeUtil.unescape(reader, writer);
  }
   ...
   * @throws IOException if an input/output exception occurs
   */
  public static func unescapeCsv(_ text : [Character], _ offset : Int, _ len : Int, _ writer : java.io.Writer)
  throws {
    ...
    try CsvEscapeUtil.unescape(text, offset, len, writer);
  }
